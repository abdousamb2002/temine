...
<div class="topbar">
  ...
  <div class="topbar-right">
    ...
    <span class="global-rec on" id="globalRecBadge" onclick="toggleGlobalRec()" title="全局录制开关：控制是否自动记录所有终端的命令和输出">● 录制中</span>
...
function updateGlobalRecUI(enabled){
  ...
  if(enabled){b.className='global-rec on';b.innerHTML='● 录制中';b.title='全局录制已开启：自动记录所有终端的命令和输出，点击暂停'}
  else{b.className='global-rec off';b.innerHTML='⏸ 已暂停';b.title='全局录制已暂停：不记录任何终端内容，点击恢复'}
}
